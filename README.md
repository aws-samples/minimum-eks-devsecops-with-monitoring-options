...
To export Falco events into Prometheus, we will need Falco Exporter. Please install Falco Exporter as a helm chart as below. Below steps are also available in [EKS Workshop](https://www.eksworkshop.com/intermediate/240_monitoring/)  –
